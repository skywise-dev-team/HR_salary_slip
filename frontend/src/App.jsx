...
import RegenerateSlips from './pages/RegenerateSlips.jsx';
...
export default function App() {
  return (
    <Routes>
      ...
      <Route path="/upload-salary/regenerate" element={<ProtectedRoute><ModuleRoute moduleKey="upload_salary"><RegenerateSlips /></ModuleRoute></ProtectedRoute>} />
